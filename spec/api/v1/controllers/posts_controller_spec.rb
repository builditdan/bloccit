 ...
 RSpec.describe Api::V1::PostsController, type: :controller do
   ...
   context "unauthenticated user" do
     ...
     it "PUT update returns http unauthenticated" do
       put :update, id: my_post.id, post: {title: "Post Name", body: RandomData.random_paragraph}
       expect(response).to have_http_status(401)
     end

     it "POST create returns http unauthenticated" do
       post :create, topic_id:my_topic.id, post: {title: "Post Name", body: RandomData.random_paragraph, topic_id: my_topic.id, user_id: my_user.id}
       expect(response).to have_http_status(401)
     end
   ...
   context "authenticated and authorized users" do
     ...
     describe "PUT update" do
       before { put :update, id: my_post.id, post: {title: @new_post.title, description: @new_post.body} }
    ...
    describe "POST create" do
      before { post :create, topic_id:@new_post.topic.id, post: {title: @new_post.title, body: @new_post.body, topic_id: @new_post.topic.id, user_id: my_user.id} }
      ...
      it "creates a posts with the correct attributes" do
